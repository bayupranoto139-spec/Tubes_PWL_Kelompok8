...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedUsers(): void
    {
        $users = [
            // Super Admin
            ['id' => 1,  'hospital_id' => null, 'name' => 'Super Administrator', 'email' => 'superadmin@healthmesh.id',  'role' => 'super_admin', 'gender' => 'L', 'date_of_birth' => '1985-01-01'],
            // Admin RS 1
            ['id' => 2,  'hospital_id' => 1,    'name' => 'Rina Sari',           'email' => 'admin@rsss.id',             'role' => 'admin_rs',    'gender' => 'P', 'date_of_birth' => '1990-03-15'],
            // Admin RS 2
            ['id' => 3,  'hospital_id' => 2,    'name' => 'Dedi Kurniawan',      'email' => 'admin@rshb.id',             'role' => 'admin_rs',    'gender' => 'L', 'date_of_birth' => '1988-07-22'],
            // Dokter RS 1
            ['id' => 4,  'hospital_id' => 1,    'name' => 'dr. Budi Santoso',    'email' => 'budi.santoso@rsss.id',      'role' => 'dokter',      'gender' => 'L', 'date_of_birth' => '1978-05-10'],
            ['id' => 5,  'hospital_id' => 1,    'name' => 'dr. Sari Indah',      'email' => 'sari.indah@rsss.id',        'role' => 'dokter',      'gender' => 'P', 'date_of_birth' => '1982-11-20'],
            // Dokter RS 2
            ['id' => 6,  'hospital_id' => 2,    'name' => 'dr. Ahmad Fauzi',     'email' => 'ahmad.fauzi@rshb.id',       'role' => 'dokter',      'gender' => 'L', 'date_of_birth' => '1975-08-30'],
            // Staff RS 1
            ['id' => 7,  'hospital_id' => 1,    'name' => 'Maya Putri',          'email' => 'maya@rsss.id',              'role' => 'staff',       'gender' => 'P', 'date_of_birth' => '1995-04-12'],
            ['id' => 8,  'hospital_id' => 1,    'name' => 'Hendra Wijaya',       'email' => 'hendra@rsss.id',            'role' => 'staff',       'gender' => 'L', 'date_of_birth' => '1993-09-05'],
            // Staff RS 2
            ['id' => 9,  'hospital_id' => 2,    'name' => 'Lena Susanti',        'email' => 'lena@rshb.id',              'role' => 'staff',       'gender' => 'P', 'date_of_birth' => '1996-02-18'],
            // Pasien
            ['id' => 10, 'hospital_id' => null, 'name' => 'Agus Setiawan',       'email' => 'agus.setiawan@gmail.com',   'role' => 'pasien',      'gender' => 'L', 'date_of_birth' => '1988-06-25'],
            ['id' => 11, 'hospital_id' => null, 'name' => 'Dewi Rahayu',         'email' => 'dewi.rahayu@gmail.com',     'role' => 'pasien',      'gender' => 'P', 'date_of_birth' => '1992-12-03'],
            ['id' => 12, 'hospital_id' => null, 'name' => 'Farhan Ramadhan',     'email' => 'farhan.ramadhan@gmail.com', 'role' => 'pasien',      'gender' => 'L', 'date_of_birth' => '2000-07-14'],
            ['id' => 13, 'hospital_id' => null, 'name' => 'Siti Nuraini',        'email' => 'siti.nuraini@gmail.com',    'role' => 'pasien',      'gender' => 'P', 'date_of_birth' => '1975-03-28'],
        ];

        $phones = ['081234567890', '082345678901', '083456789012', '084567890123',
                   '085678901234', '086789012345', '087890123456', '088901234567',
                   '089012345678', '081122334455', '082233445566', '083344556677', '084455667788'];

        foreach ($users as $i => $u) {
            DB::table('users')->insert(array_merge($u, [
                'password'   => Hash::make('password'),
                'phone'      => $phones[$i],
                'address'    => 'Jl. Contoh No. ' . ($i + 1) . ', Medan',
                'is_active'  => 1,
                'created_at' => now(),
                'updated_at' => now(),
            ]));
    ...
    private function seedPatientMedicalInfos(): void
    {
        $infos = [
            [
                ...
                'blood_type'              => 'A',
                'allergies'               => 'Penisilin',
                'emergency_contact_name'  => 'Siti Setiawan',
                'emergency_contact_phone' => '081298765432',
                'insurance_provider'      => 'BPJS Kesehatan',
                'insurance_policy_number' => 'BPJS-00123456',
            ],
            [
                'user_id'                 => 11,
                'blood_type'              => 'O',
                'allergies'               => null,
                'emergency_contact_name'  => 'Budi Rahayu',
                'emergency_contact_phone' => '082198765432',
                'insurance_provider'      => 'BPJS Kesehatan',
                'insurance_policy_number' => 'BPJS-00234567',
            ],
            [
                'user_id'                 => 12,
                'blood_type'              => 'B',
                'allergies'               => 'Sulfa, Aspirin',
                'emergency_contact_name'  => 'Rina Ramadhan',
                'emergency_contact_phone' => '083198765432',
            ...
            [
                ...
                'blood_type'              => 'AB',
                'allergies'               => null,
                'emergency_contact_name'  => 'Hasan Nuraini',
                'emergency_contact_phone' => '084198765432',
                'insurance_provider'      => 'Asuransi Mandiri',
                'insurance_policy_number' => 'AM-9988776655',
            ],
        ];
    ...
    private function seedPatientEnrollments(): void
    {
        $enrollments = [
            ...
            // Pasien 10 juga terdaftar di RS 2
            ['id' => 5, 'user_id' => 10, 'hospital_id' => 2, 'medical_record_number' => 'RSHB-2024-0001'],
    ...
    {
        $schedules = [
            // dr. Budi (dokter umum) — Senin, Rabu, Jumat pagi
            ...
            // dr. Sari (jantung) — Selasa dan Kamis
    ...
    private function seedAppointments(): void
    {
        $appointments = [
            ...
            // Appointment hari ini (scheduled)
    ...
    private function seedMedicalRecords(): void
    {
        $records = [
            [
                'id'             => 1,
                'appointment_id' => 1,
                'visit_date'     => Carbon::yesterday()->setTime(9, 8),
                'diagnosis'      => 'Demam tifoid ringan',
                'treatment_plan' => 'Pemberian antibiotik, istirahat cukup, minum banyak air putih',
                'notes'          => 'Pasien disarankan kontrol kembali dalam 5 hari',
                'case_status'    => 'active',
            ],
            [
                'id'             => 2,
                'appointment_id' => 2,
                'visit_date'     => Carbon::yesterday()->setTime(9, 33),
                'diagnosis'      => 'Bronkitis akut',
                'treatment_plan' => 'Pemberian mukolitik dan ekspektoran, hindari rokok dan polusi',
                'notes'          => 'Jika tidak membaik dalam 3 hari, rontgen thorax',
                'case_status'    => 'active',
            ],
            [
                'id'             => 3,
                'appointment_id' => 3,
                'visit_date'     => Carbon::yesterday()->setTime(10, 8),
                'diagnosis'      => 'Angina pektoris stabil',
                'treatment_plan' => 'Pemberian nitrat sublingual, beta blocker, dan modifikasi gaya hidup',
                'notes'          => 'Jadwalkan stress test dan echocardiography',
                'case_status'    => 'active',
            ],
            [
                'id'             => 4,
                'appointment_id' => 7,
                'visit_date'     => Carbon::today()->setTime(10, 23),
                'diagnosis'      => 'Vertigo perifer (BPPV)',
                'treatment_plan' => 'Manuver Epley, betahistin jika perlu',
                'notes'          => 'Hindari perubahan posisi mendadak',
                'case_status'    => 'healed',
            ],
            [
                'id'             => 5,
                'appointment_id' => 10,
                'visit_date'     => Carbon::yesterday()->setTime(13, 12),
                'diagnosis'      => 'Febris e.c. infeksi virus (common cold)',
                'treatment_plan' => 'Antipiretik, perbanyak minum dan istirahat',
                'notes'          => 'Kompres hangat jika demam di atas 38.5°C',
                'case_status'    => 'healed',
            ],
        ];
    ...
    {
        $bills = [
            // Tagihan untuk appointment completed — sudah lunas
            [
                'id'                    => 1,
                'patient_enrollment_id' => 1,
                'appointment_id'        => 1,
                'total_amount'          => 0, // akan di-update setelah bill_items
                'status'                => 'paid',
            ...
            [
                ...
                'reference_number'      => 'TRF-20240524-001',
            ],
            // Walk-in — sudah lunas
            [
                'id'                    => 4,
                ...
                'reference_number'      => 'QRIS-' . now()->format('YmdHis'),
            ],
            // Tagihan appointment hari ini — belum lunas
            [
                'id'                    => 5,
                'patient_enrollment_id' => 1,
                'appointment_id'        => 4,
            ...
            [
                ...
                'reference_number'      => 'INS-AM-20240524-001',
            ],
        ];

        // Ganti 'bpjs' ke enum yang valid
        foreach ($bills as &$b) {
            if ($b['payment_method'] === 'bpjs') {
                $b['payment_method'] = 'insurance';
            }
        }

        foreach ($bills as $b) {
            DB::table('bills')->insert(array_merge($b, [
                'created_at' => now(),
                'updated_at' => now(),
            ]));
        }
    ...
    // ============================================================
    // 15. BILL ITEMS + sync total_amount
    // ============================================================

    private function seedBillItems(): void
    {
        $items = [
            // Bill 1 — demam tifoid (dokter umum)
            ['bill_id' => 1, 'item_type' => 'consultation', 'description' => 'Biaya Konsultasi Dokter Umum',    'quantity' => 1,  'unit_price' => 150000],
            ['bill_id' => 1, 'item_type' => 'medication',   'description' => 'Amoxicillin 500mg (21 kapsul)',   'quantity' => 21, 'unit_price' => 2500],
            ['bill_id' => 1, 'item_type' => 'medication',   'description' => 'Paracetamol 500mg (15 tablet)',   'quantity' => 15, 'unit_price' => 500],
            ['bill_id' => 1, 'item_type' => 'medication',   'description' => 'Vitamin C 500mg (10 tablet)',     'quantity' => 10, 'unit_price' => 500],
            ['bill_id' => 1, 'item_type' => 'administration','description' => 'Biaya Administrasi',             'quantity' => 1,  'unit_price' => 15000],

            // Bill 2 — bronkitis
            ['bill_id' => 2, 'item_type' => 'consultation', 'description' => 'Biaya Konsultasi Dokter Umum',    'quantity' => 1,  'unit_price' => 150000],
            ['bill_id' => 2, 'item_type' => 'medication',   'description' => 'Salbutamol 4mg (15 tablet)',      'quantity' => 15, 'unit_price' => 1200],
            ['bill_id' => 2, 'item_type' => 'medication',   'description' => 'Paracetamol 500mg (9 tablet)',    'quantity' => 9,  'unit_price' => 500],
            ['bill_id' => 2, 'item_type' => 'administration','description' => 'Biaya Administrasi',             'quantity' => 1,  'unit_price' => 15000],

            // Bill 3 — angina pektoris (spesialis jantung)
            ['bill_id' => 3, 'item_type' => 'consultation', 'description' => 'Biaya Konsultasi Spesialis Jantung','quantity' => 1, 'unit_price' => 350000],
            ['bill_id' => 3, 'item_type' => 'medication',   'description' => 'Amlodipine 5mg (30 tablet)',      'quantity' => 30, 'unit_price' => 1500],
            ['bill_id' => 3, 'item_type' => 'medication',   'description' => 'Omeprazole 20mg (14 kapsul)',     'quantity' => 14, 'unit_price' => 3000],
            ['bill_id' => 3, 'item_type' => 'procedure',    'description' => 'Biaya EKG',                       'quantity' => 1,  'unit_price' => 150000],
            ['bill_id' => 3, 'item_type' => 'administration','description' => 'Biaya Administrasi',             'quantity' => 1,  'unit_price' => 25000],

            // Bill 4 — walk-in vertigo
            ['bill_id' => 4, 'item_type' => 'consultation', 'description' => 'Biaya Konsultasi Dokter Umum',    'quantity' => 1, 'unit_price' => 150000],
            ['bill_id' => 4, 'item_type' => 'medication',   'description' => 'Cetirizine 10mg (3 tablet)',      'quantity' => 3, 'unit_price' => 2000],
            ['bill_id' => 4, 'item_type' => 'administration','description' => 'Biaya Administrasi',             'quantity' => 1, 'unit_price' => 15000],

            // Bill 5 — kontrol tekanan darah (belum lunas)
            ['bill_id' => 5, 'item_type' => 'consultation', 'description' => 'Biaya Konsultasi Dokter Umum',    'quantity' => 1, 'unit_price' => 150000],
            ['bill_id' => 5, 'item_type' => 'administration','description' => 'Biaya Administrasi',             'quantity' => 1, 'unit_price' => 15000],

            // Bill 6 — demam anak RS 2
            ['bill_id' => 6, 'item_type' => 'consultation', 'description' => 'Biaya Konsultasi Spesialis Anak', 'quantity' => 1,  'unit_price' => 300000],
            ['bill_id' => 6, 'item_type' => 'medication',   'description' => 'Paracetamol 500mg (6 tablet)',    'quantity' => 6,  'unit_price' => 500],
            ['bill_id' => 6, 'item_type' => 'medication',   'description' => 'Vitamin C 500mg (5 tablet)',      'quantity' => 5,  'unit_price' => 500],
            ['bill_id' => 6, 'item_type' => 'administration','description' => 'Biaya Administrasi',             'quantity' => 1,  'unit_price' => 25000],
        ];
        ...
        // Sync total_amount di bills berdasarkan SUM(bill_items.subtotal)
        DB::statement("
            UPDATE bills b
            SET b.total_amount = (
